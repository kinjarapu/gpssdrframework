...
/* GN3S Stuff */
/*--------------------------------------------------------------*/
#define GN3S_VID_V2			(0x16C0)
#define GN3S_PID_V2			(0x072F)
#define GN3S_VID			(0x1781)
#define GN3S_PID			(0x0B38)
...
class gn3s
{
	...
	public:
		...
		/* tell the difference between version 1 (real samples, IF = 4.1304 MHz, Fs = 16.3676 MHz)
		 * and version 2 (I/Q samples, near-zero IF, Fs = 8.1838MHz) */
		int gn3s_version;
};
/*--------------------------------------------------------------*/
