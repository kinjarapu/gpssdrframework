...
#ifdef NO_SIMD
	static void rank(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize);
	static void rankdf(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize);
	static void rank_noscale(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize);
	static void rankdf_noscale(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize);
	static void bfly(CPX *_A, CPX *_B, MIX *_W);
	void bflydf(CPX *_A, CPX *_B, MIX *_W);
	void bfly_noscale(CPX *_A, CPX *_B, MIX *_W);
	void bflydf_noscale(CPX *_A, CPX *_B, MIX *_W);
#else
	static void rank(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)  __attribute__ ((noinline));
	static void rankdf(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)  __attribute__ ((noinline));
	static void rank_noscale(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)  __attribute__ ((noinline));
	static void rankdf_noscale(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)  __attribute__ ((noinline));
#endif
...
FFT::FFT(int32_t _N)
{
	...
	BR  = (int32_t *)malloc(N*sizeof(int32_t)); 	// Bit reverse lookup
	BRX  = (int32_t *)malloc(N*sizeof(CPX)); 	// Shuffle temp array
...
FFT::FFT(int32_t _N, int32_t _R[MAX_RANKS])
{
...
void FFT::doFFTdf(CPX *_x, bool _shuf)
{
	...
	int32_t lcv, lcv2, lcv3;
	int32_t bsize, nblocks;
	CPX *a, *b;
	MIX *w;
...
void rank(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)
{
...
void rank_noscale(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)
{
...
void rankdf(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)
{
...
void rankdf_noscale(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32_t _bsize)
{
...
void rank(CPX *_A, CPX *_B, MIX *_W, int32_t _nblocks, int32 _bsize)
{
