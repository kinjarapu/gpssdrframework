...
void Commando::setPeriodic()
{
	...
	uint32_t decim; 	//!< Decimation rate
...
/*----------------------------------------------------------------------------------------------*/
void Commando::PageWrite(uint32_t _bank, uint32_t *_addr, uint32_t *_data, uint32_t _words)
{
...
/*----------------------------------------------------------------------------------------------*/
void Commando::PendEEPROM(uint32_t _bank)
{
...
/*----------------------------------------------------------------------------------------------*/
void Commando::EmitCCSDSPacket(void *_buff, uint32_t _len)
{
