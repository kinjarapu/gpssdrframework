...
/*----------------------------------------------------------------------------------------------*/
uint32_t Threaded_Object::Trylock()
{
...
/*----------------------------------------------------------------------------------------------*/
uint32_t Threaded_Object::getExecTic()
{
...
/*----------------------------------------------------------------------------------------------*/
uint32_t Threaded_Object::getStartTic()
{
	return(start_tic);
}
/*----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------*/
uint32_t Threaded_Object::getStopTic()
{
	return(stop_tic);
}
/*----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------*/
uint32_t Threaded_Object::getSize()
{
	return(size);
}
/*----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------*/
uint32_t Threaded_Object::getStack()
{
	return(stack);
}
/*----------------------------------------------------------------------------------------------*/
