...
/*----------------------------------------------------------------------------------------------*/
GUI_Toplevel::GUI_Toplevel():iGUI_Toplevel(NULL, wxID_ANY, wxT("GPS-SDR GUI (mod by Michele Bavaro)"), wxDefaultPosition, wxSize(600,600), wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL, wxT("GPS GUI") )
{
